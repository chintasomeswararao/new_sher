...
// Only using deep-research mode now
...
function PureMultimodalInput({
  ...
  const submitForm = useCallback(() => {
    ...
    // Only call handleSubmit to submit the query (no manual fetch)
    handleSubmit(undefined, {
      experimental_attachments: attachments,
      experimental_deepResearch: true, // Always enable deep research
    });
  ...
  return (
    <div className="relative w-full flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        {/* Remove or comment out the DeepResearch component here since it's now handled at the chat level */}
        {/* <DeepResearch
          isActive={true}
          onToggle={() => {}}
          isLoading={isLoading}
      ...
      <div className="absolute bottom-0 p-2 flex flex-row gap-2 justify-start items-center">
        ...
        <div className="rounded-full px-3 py-1.5 h-fit flex items-center gap-2 bg-orange-50 text-orange-600">
          <Telescope size={14} />
          Deep Research
        </div>
      </div>
